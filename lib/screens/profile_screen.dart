        ...
        children: [
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    image: const DecorationImage(fit: BoxFit.cover, image: AssetImage('assets/images/img_1.png'))),
              ),
              ...
              Column(
                ...
                children: [
                  ...
                  Container(
                    padding: EdgeInsets.symmetric(horizontal: AppLayout.getHeight(context, 3), vertical: AppLayout.getWidth(context, 3)),
                    decoration: BoxDecoration(
            ...
            children: [
              ...
              Positioned(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        shape: BoxShape.circle, color: Colors.transparent, border: Border.all(width: 18, color: const Color(0xff264cd2))),
                  )),
              Container(
                padding: EdgeInsets.symmetric(horizontal: AppLayout.getHeight(context, 25), vertical: AppLayout.getHeight(context, 20)),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.start,
          ...
          Column(
            children: [
              ...
              Gap(AppLayout.getHeight(context, 24)),
              Text(

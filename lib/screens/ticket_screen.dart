    ...
    return Scaffold(
        ...
        body: Stack(
          children: [
              ...
              children: [
                ...
                Container(
                  decoration: const BoxDecoration(
                      color: Colors.white, borderRadius: BorderRadius.only(bottomRight: Radius.circular(21), bottomLeft: Radius.circular(21))),
                  padding: EdgeInsets.symmetric(horizontal: AppLayout.getWidth(context, 15), vertical: AppLayout.getWidth(context, 20)),
                  margin: EdgeInsets.symmetric(horizontal: AppLayout.getWidth(context, 15)),
                  child: Column(
                    children: [
                      Row(
                      ...
                      Gap(AppLayout.getHeight(context, 20)),
                      Container(
                        padding: EdgeInsets.symmetric(horizontal: AppLayout.getHeight(context, 5)),
                        child: ClipRRect(
            ...
            Positioned(
              left: AppLayout.getWidth(context, 22),
            ...
            Positioned(
              right: AppLayout.getWidth(context, 22),
              top: AppLayout.getHeight(context, 295),
              child: Container(
                padding: const EdgeInsets.all(3),
                decoration: BoxDecoration(shape: BoxShape.circle, border: Border.all(color: Styles.textColor, width: 2)),

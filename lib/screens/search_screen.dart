    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          Text(
            'What are\nyou looking for?',
            style: Styles.headLineStyle1.copyWith(fontSize: AppLayout.getHeight(context, 35)),
          ),
          ...
          Gap(AppLayout.getHeight(context, 25)),
          Container(
            padding: EdgeInsets.symmetric(vertical: AppLayout.getHeight(context, 18), horizontal: AppLayout.getWidth(context, 15)),
          ...
          Row(
            ...
            children: [
              Container(
                ...
                padding: EdgeInsets.symmetric(horizontal: AppLayout.getHeight(context, 15), vertical: AppLayout.getWidth(context, 15)),
                decoration: BoxDecoration(
                    color: Colors.white,
              ...
              Column(
                children: [
                  Stack(
                    children: [
                      Container(
                        padding: EdgeInsets.symmetric(vertical: AppLayout.getHeight(context, 15), horizontal: AppLayout.getWidth(context, 15)),
                        width: size.width * 0.44,
                        height: AppLayout.getHeight(context, 200),
                        decoration:
                            BoxDecoration(color: const Color(0xff3ab8b8), borderRadius: BorderRadius.circular(AppLayout.getHeight(context, 18))),
                        child: Column(
